...
export default function Navbar() {
  ...
  return (
    <nav className="h-[4rem] bg-wowPrimary w-full flex-wrap justify-between flex flex-row items-center px-5 fixed z-10 ">
      <div className="flex items-center flex-row gap-5">
        ...
        <ul className="list-none flex flex-row gap-4 text-white text-lg">
          {routes.map((e) => (
            <li key={e.key} className="text-white text-md font-bold">
